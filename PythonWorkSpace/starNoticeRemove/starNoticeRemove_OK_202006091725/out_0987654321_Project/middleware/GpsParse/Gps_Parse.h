 ...
 * CallByAPI           Task_NM
 */
extern void GpsUartInit(void);
extern void Gps_InfoAnalysis( const sint8 * buff,uint16 buff_size);
extern void Gps_RMCInfoPackage(float latitude,float longitude);
