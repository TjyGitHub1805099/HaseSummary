...
tUdsChInfor gUdsChInfor[UDS_CH_MAX_NUM] = {
		{UDS_ADDR_TYPE_PHY,FALSE,UDS_CH_STATUS_IDLE,FALSE,2,0,UDS_PHY_BUFF_LEN,(uint8*)gUdsRxTxBuffer_IVI},
		{UDS_ADDR_TYPE_PHY,FALSE,UDS_CH_STATUS_IDLE,FALSE,2,0,UDS_PHY_BUFF_LEN,(uint8*)gUdsRxTxBuffer_IC},
		{UDS_ADDR_TYPE_PHY,FALSE,UDS_CH_STATUS_IDLE,FALSE,2,0,UDS_PHY_BUFF_LEN,(uint8*)gUdsRxTxBuffer_AVM},
		{UDS_ADDR_TYPE_PHY,FALSE,UDS_CH_STATUS_IDLE,FALSE,2,0,UDS_PHY_BUFF_LEN,(uint8*)gUdsRxTxBuffer_HUD},
};
