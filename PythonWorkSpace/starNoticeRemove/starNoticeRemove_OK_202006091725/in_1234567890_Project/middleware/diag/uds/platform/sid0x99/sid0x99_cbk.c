...
typedef enum{
	...
	INNER_TEST_REQ_ENABLE_UPGRADE_BY_UDS,// 2
	INNER_TEST_REQ_UDS_WORK_MODE,// 3
	INNER_TEST_REQ_ECU_NAME, // 4
...
/*
liqi,20200219
WARNING: these variables are for UDS UPGRADING,CAN'T BE REMOVED
*/
//====>
