...
extern void wllrMainLoop();
extern boolean ameParseNewMsg();

extern NVM_SEC_VAR_UNSPECIFIED tWlInfor gWarningLampLightingRecords[];  //define in diagAppWllr_cfg.c line 6
