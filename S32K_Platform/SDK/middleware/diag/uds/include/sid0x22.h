...
typedef tUdsNRCType (*tVerifyFnCbk)(uint16 didNum,const uint8*data,uint16 len);
typedef uint16 (*tReadFnCbk)(uint8*respData);
typedef tUdsNRCType (*tWriteFnCbk)(uint16 didNum,const uint8*data,uint16 len);
