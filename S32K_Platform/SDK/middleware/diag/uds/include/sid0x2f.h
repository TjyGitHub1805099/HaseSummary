...
typedef const tIOCtrlBuffer* (*tIOCtrlStartCbk)(const uint8*data,uint16 len);
typedef tUdsNRCType (*tIOCtrlVerifyCbk)(const uint8 *data, uint16 len);
typedef const tIOCtrlBuffer* (*IOCtrlStopCbk)(tIOControlParameterType req);
