...
/********************************************************************
File name: Task_SpiCoreRead.c
Author: Stephen Du
Version: V1.0
Timestamp: 2018-11-16 18:12:50
Description:
Others:
Function List:
1. ....
...
#include "Task_SpiCoreRead_Cfg.h"
#if (STD_ON == TASK_SPICOREREAD_DEBUG_TRACE)
#include "trace.h"
#endif
/*********** START: INCLUDE FILES ************/
...
void Task_SpiCoreRead(void * pvParameters)
{
...
#if (STD_ON == TASK_SPICOREREAD_STACK_MONITOR)
	...
	/*
	System_Signal_Subscribe(SYSTEM_SIG_ID_XXX, SYSTEM_TASK_ID_SPICOREREAD);
	System_Signal_SubSpecValue(SYSTEM_SIG_ID_XXX, SYSTEM_TASK_ID_SPICOREREAD, X);
	*/
	...
	while (1)
	{
		l_returnValue = System_Task_ReceiveMessage(SYSTEM_TASK_ID_SPICOREREAD, &l_msgInfo, FALSE, OS_WAITFOREVER);
		if (E_OK == l_returnValue)
		{
			...
			{
#if (STD_ON == TASK_SPICOREREAD_DEBUG_TRACE)
				TracePrintf(SPICOREREAD_TRACE, TRACE_INFO, "[Task_SpiCoreRead-I]:Some infomation\r\n");
#endif
			}*/
...
#if (STD_ON == TASK_SPICOREREAD_DEBUG_TRACE)
			TracePrintf(SPICOREREAD_TRACE, TRACE_WARNING, "[Task_SpiCoreRead-W]:Stack Size:%d\r\n",l_stackSize);
#endif
#endif
		}
	}
}
/*=========================== END OF FILE: Task_SpiCoreRead.c ===========================*/
