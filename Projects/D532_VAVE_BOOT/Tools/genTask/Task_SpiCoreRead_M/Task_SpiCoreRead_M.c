...
/********************************************************************
File name: Task_SpiCoreRead_M.c
Author: Stephen Du
Version: V1.0
...
#include "Task_SpiCoreRead_M_Cfg.h"
#if (STD_ON == TASK_SPICOREREAD_M_DEBUG_TRACE)
#include "trace.h"
#endif
/*********** START: INCLUDE FILES ************/
...
void Task_SpiCoreRead_M(void * pvParameters)
{
...
#if (STD_ON == TASK_SPICOREREAD_M_STACK_MONITOR)
	...
	/*
	System_Signal_Subscribe(SYSTEM_SIG_ID_XXX, SYSTEM_TASK_ID_SPICOREREAD_M);
	System_Signal_SubSpecValue(SYSTEM_SIG_ID_XXX, SYSTEM_TASK_ID_SPICOREREAD_M, X);
	*/
	...
	while (1)
	{
		l_returnValue = System_Task_ReceiveMessage(SYSTEM_TASK_ID_SPICOREREAD_M, &l_msgInfo, FALSE, OS_WAITFOREVER);
		if (E_OK == l_returnValue)
		{
			...
			{
#if (STD_ON == TASK_SPICOREREAD_M_DEBUG_TRACE)
				TracePrintf(SPICOREREAD_M_TRACE, TRACE_INFO, "[Task_SpiCoreRead_M-I]:Some infomation\r\n");
#endif
			}*/
...
#if (STD_ON == TASK_SPICOREREAD_M_DEBUG_TRACE)
			TracePrintf(SPICOREREAD_M_TRACE, TRACE_WARNING, "[Task_SpiCoreRead_M-W]:Stack Size:%d\r\n",l_stackSize);
#endif
#endif
		}
	}
}
/*=========================== END OF FILE: Task_SpiCoreRead_M.c ===========================*/
