...
#include "Task_SpiCoreRx0_Cfg.h"
#if (STD_ON == TASK_SPICORERX0_DEBUG_TRACE)
#include "trace.h"
#endif
/*********** START: INCLUDE FILES ************/
...
void Task_SpiCoreRx0(void * pvParameters)
{
...
#if (STD_ON == TASK_SPICORERX0_STACK_MONITOR)
	...
	/*
	System_Signal_Subscribe(SYSTEM_SIG_ID_XXX, SYSTEM_TASK_ID_SPICORERX0);
	System_Signal_SubSpecValue(SYSTEM_SIG_ID_XXX, SYSTEM_TASK_ID_SPICORERX0, X);
	*/
	...
	while (1)
	{
		l_returnValue = System_Task_ReceiveMessage(SYSTEM_TASK_ID_SPICORERX0, &l_msgInfo, FALSE, OS_WAITFOREVER);
		if (E_OK == l_returnValue)
		{
			...
			{
#if (STD_ON == TASK_SPICORERX0_DEBUG_TRACE)
				TracePrintf(SPICORERX0_TRACE, TRACE_INFO, "[Task_SpiCoreRx0-I]:Some infomation\r\n");
#endif
			}*/
...
#if (STD_ON == TASK_SPICORERX0_DEBUG_TRACE)
			TracePrintf(SPICORERX0_TRACE, TRACE_WARNING, "[Task_SpiCoreRx0-W]:Stack Size:%d\r\n",l_stackSize);
#endif
#endif
		}
	}
}
/*=========================== END OF FILE: Task_SpiCoreRx0.c ===========================*/
