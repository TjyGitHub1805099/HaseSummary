...
extern void Task_SWDL(void * pvParameters);
...
const char Task_Name_SWDL[] = {"SWDL"};
...
SystemTaskConfigType SystemTaskConfig[SYSTEM_TASK_ID_MAX] =
{
	...
	{&Task_Name_SysMonitor[0], 7, 512, Task_SysMonitor, NULL, STD_ON, 3},
	{&Task_Name_Alarm[0], 13, 256, Task_Alarm, NULL, STD_ON, 3},
	{&Task_Name_General[0], 7, 512, Task_General, NULL, STD_ON, 3},
	{&Task_Name_SWDL[0], 8, 512, Task_SWDL, NULL, STD_ON, 3},
	{&Task_Name_SpiCoreRead_M[0], 9, 512, Task_SpiCoreRead_M, NULL, STD_ON, 1},
