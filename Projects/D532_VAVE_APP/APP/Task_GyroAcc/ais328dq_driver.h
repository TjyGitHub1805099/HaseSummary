...
status_t1 AIS328DQ_SetFilterDataSel(State_t state);
status_t1 AIS328DQ_SetReference(i8_t ref);

//Interrupt Functions
status_t1 AIS328DQ_SetIntHighLow(State_t hil);
...
status_t1 AIS328DQ_GetAcAxesRaw(AccRaw_t* buff);
