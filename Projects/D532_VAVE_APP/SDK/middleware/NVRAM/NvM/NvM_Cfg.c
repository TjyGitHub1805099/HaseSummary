...
extern  uint32_t g_odo_Odo;
extern  uint32_t g_odo_back;
extern  ODO_PARA_STRU g_odo_para;
extern  VEL_CODING_STRU g_VEL_Coding;
extern  VEL_LT_CFG_STRU g_VEL_LT_Config;
extern  SERV_CODING_STRU g_SERV_Coding;
extern  UNIT_STRU g_Unit_Coding;
extern  IPC_APP_SYS_SETTING_STRU g_sys_setting;
extern  boolean gEnableTpTraceByCanFlag;
extern  uint8 socSerialNum[];
extern  uint8 g_IVI_VIN[];
extern  uint8 gIVI_PKI_CERTIFICATE[];
extern  uint32_t g_odo_back1;
