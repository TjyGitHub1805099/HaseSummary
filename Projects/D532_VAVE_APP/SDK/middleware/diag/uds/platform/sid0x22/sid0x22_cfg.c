...
const t0x22DidInfo g0x22DidInfor_AVM[] = {
	...
	{AVM_DID_SYS_SUPPLIER_NUM,					         DID_READ,
	 UDS_INNER_SECURITY_LEVEL_0,						 UDS_INNER_SECURITY_LEVEL_0, 
	 FALSE, 											 FALSE, 				
	 AVM_DID_SYS_SUPPLIER_NUM_LEN,				         g_AVM_SysSupplierNum,
	 0, 												 FALSE,
	 NULL_PTR,                                           NULL_PTR,
	 NULL_PTR},
	...
	{AVM_DID_DIAG_ID_CODE,			                     DID_READ,
	 UDS_INNER_SECURITY_LEVEL_0,						 UDS_INNER_SECURITY_LEVEL_0, 
	 FALSE, 											 FALSE, 				
	 AVM_DID_DIAG_ID_CODE_LEN,		                     g_AVM_DiagIdCode,
	 0, 												 FALSE,
	 NULL_PTR,                                           NULL_PTR,
	 NULL_PTR},
...
{	
	...
	switch (ampVersion)
	{
		case HSAE_CA004:
			...
			diagCpyData(g_IVI_SparePartsNumNissan, "259152GN0A", IVI_DID_SPARE_PARTS_NUM_NISSAN_LEN); //AVM use the same value as DA
			diagCpyData(g_IVI_VehicleManufEcuHwNum, "259152GN0A", IVI_DID_VEHICLE_MANUF_ECU_HW_NUM_LEN); //AVM use the same value as DA
			diagCpyData(g_IVI_OperationalReference, "259152GN0A", IVI_DID_OPERATIONAL_REFERENCE_LEN); //AVM use the same value as DA
		
			diagCpyData(g_IC_SparePartsNumNissan, "248102GN0A", IC_DID_SPARE_PARTS_NUM_NISSAN_LEN); //AVM use the same value as DA
			break;
		case HSAE_CA005:
		...
		case HSAE_CA002:
			...
			gUdsChSupportFlag[UDS_AVM] = FALSE;
			gUdsChSupportFlag[UDS_HUD] = FALSE;
			diagCpyData(g_IVI_SparePartsNumNissan, "259152GN0B", IVI_DID_SPARE_PARTS_NUM_NISSAN_LEN); //AVM use the same value as DA
			diagCpyData(g_IVI_VehicleManufEcuHwNum, "259152GN0B", IVI_DID_VEHICLE_MANUF_ECU_HW_NUM_LEN); //AVM use the same value as DA
			diagCpyData(g_IVI_OperationalReference, "259152GN0B", IVI_DID_OPERATIONAL_REFERENCE_LEN); //AVM use the same value as DA
			
			diagCpyData(g_IC_SparePartsNumNissan, "248102GN0B", IC_DID_SPARE_PARTS_NUM_NISSAN_LEN); //AVM use the same value as DA			
			break;
		case HSAE_CA003:
			gUdsChSupportFlag[UDS_HUD] = FALSE;
			diagCpyData(g_IVI_SparePartsNumNissan, "259152GN0C", IVI_DID_SPARE_PARTS_NUM_NISSAN_LEN); //AVM use the same value as DA
			diagCpyData(g_IVI_VehicleManufEcuHwNum, "259152GN0C", IVI_DID_VEHICLE_MANUF_ECU_HW_NUM_LEN); //AVM use the same value as DA
			diagCpyData(g_IVI_OperationalReference, "259152GN0C", IVI_DID_OPERATIONAL_REFERENCE_LEN); //AVM use the same value as DA
		
			diagCpyData(g_IC_SparePartsNumNissan, "248102GN0B", IC_DID_SPARE_PARTS_NUM_NISSAN_LEN); //AVM use the same value as DA			
			break;
		case HSAE_CA001:
			
			diagCpyData(g_IVI_SparePartsNumNissan, "259152GN0D", IVI_DID_SPARE_PARTS_NUM_NISSAN_LEN); //AVM use the same value as DA
			diagCpyData(g_IVI_VehicleManufEcuHwNum, "259152GN0D", IVI_DID_VEHICLE_MANUF_ECU_HW_NUM_LEN); //AVM use the same value as DA
			diagCpyData(g_IVI_OperationalReference, "259152GN0D", IVI_DID_OPERATIONAL_REFERENCE_LEN); //AVM use the same value as DA
