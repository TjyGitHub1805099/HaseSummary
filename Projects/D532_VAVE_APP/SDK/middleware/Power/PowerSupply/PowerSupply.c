...
void PowerOff(void)
{
	...
	//======================================SOC : AMP=========================================
	//external AMP ,must delay then power off UG3V3_ON , to sove pop noice ,chaned by tjy @2019-12-16
...
void SysResetWrapper_AndStore(uint32 moduleID)
{
	...
	DelayMs(700);
	TracePrintf(PM_TRACE, TRACE_ERRO, "[PM-I]:if reset ,power done!!\n\r");
