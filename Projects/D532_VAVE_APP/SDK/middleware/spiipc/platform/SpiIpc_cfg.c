...
uint8 SpiReadWriteTmpBuf[SPI_MAX_FRAME_SIZE];	//just use for nxp spi driver bug
...
{1,							2},	//ch 0
{3,							4},	//ch 1
{SPI_CQUEUE_TXCH_SIZE, 		SPI_CQUEUE_RXCH_SIZE},		//ch 2 	event import
{SPI_CQUEUE_TXCH_SIZE, 		SPI_IPC_QUEUE_MIN_SIZE},	//ch 3 	periodicity
{SPI_CQUEUE_TXCH_SIZE,	 	SPI_CQUEUE_RXCH_SIZE},		//ch 4 	can,hardware
{SPI_IPC_QUEUE_MIN_SIZE, 	SPI_CQUEUE_RXCH_SIZE},		//ch 5	audio
{SPI_IPC_QUEUE_MIN_SIZE,	SPI_IPC_QUEUE_MIN_SIZE},	//ch 6	update
};
...
{5,						6},	//ch 0
{7,						8},	//ch 1
{SPI_CQUEUE_TXCH_SIZE,	SPI_CQUEUE_RXCH_SIZE},	//ch 2
{SPI_CQUEUE_TXCH_SIZE,	SPI_CQUEUE_RXCH_SIZE},	//ch 3
{SPI_CQUEUE_TXCH_SIZE,	SPI_CQUEUE_RXCH_SIZE},	//ch 4
{SPI_CQUEUE_TXCH_SIZE,	SPI_CQUEUE_RXCH_SIZE},	//ch 5
{SPI_CQUEUE_TXCH_SIZE,	SPI_CQUEUE_RXCH_SIZE},	//ch 6
{SPI_CQUEUE_TXCH_SIZE,	SPI_CQUEUE_RXCH_SIZE},	//ch 7
{SPI_CQUEUE_TXCH_SIZE,	SPI_CQUEUE_RXCH_SIZE},	//ch 8
{SPI_CQUEUE_TXCH_SIZE,	SPI_CQUEUE_RXCH_SIZE},	//ch 9
{SPI_CQUEUE_TXCH_SIZE,	SPI_CQUEUE_RXCH_SIZE},	//ch 10
};
