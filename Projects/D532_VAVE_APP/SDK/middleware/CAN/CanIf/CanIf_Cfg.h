...
//===================================================================================
#define CANIF_TX_PDU_CFG_CBK_ID_0       18           // IC diagnosis for other modules
#define CANIF_TX_PDU_CFG_CBK_ID_1       20 //20      //PHY1   IC
#define CANIF_TX_PDU_CFG_CBK_ID_2       22 //21      //PHY2   IVI
#define CANIF_TX_PDU_CFG_CBK_ID_3       23 //22      //PHY3   AVM
#define CANIF_TX_PDU_CFG_CBK_ID_4       19 //23      //PHY3   HUD
#define CANIF_TX_PDU_CFG_CBK_ID_5       21 //                 AME
...
#define CANIF_RX_PDU_NUM_0 30 //31 //35 //34 //33
#endif

#ifdef CAN_CHN_CFG_1
#define CANIF_RX_FILTER_NUM_1 20
#define CANIF_TX_PDU_NUM_1 16 //16
#define CANIF_RX_PDU_NUM_1 47 //45 //46 //42
#endif
